...
void sTask_MqttProcesser(void) // thread of control
{
    ...
    while (1)
    {
        ...
        case 0:
            ...
            ret = sAPI_MqttConnect(0, NULL, 0, "tcp://171.244.143.71:1883", 60, 1, "364072", "productA");
        ...
        case 2:
            ...
            ret = sAPI_MqttPayload(0, rxbuf, readsize);
