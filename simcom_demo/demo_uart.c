...
void UartDemo(void)
{
    ...
    UINT8 stopBitOpt = 0;
    UINT8 rxStatus;
    INT8 configbuf[uart_config_size];
    INT8 paritybitbuf[frame_format_buf_size];
    INT8 stopbitbuf[frame_format_buf_size];
    INT8 databitbuf[frame_format_buf_size];
...
reSelectCtrl:
            ...
            case SC_UART_DEMO_INTERNAL_AT_CMD:
            {
                ...
                char respStr[20];
                int ret = sAPI_SendATCMDWaitResp(10, "AT+CPIN?\r", 150, "+CPIN", 1, NULL, respStr, sizeof(respStr));
